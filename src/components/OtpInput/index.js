...
import { View, TextInput, Text, TouchableWithoutFeedback, Keyboard, Platform, I18nManager} from 'react-native'
...
export default class OTPInputView extends Component {
    ...
    renderOneInputField = (_, index) => {
        const { codeInputFieldStyle, codeInputHighlightStyle, secureTextEntry, editable, keyboardType, selectionColor, keyboardAppearance, isDashEnabled } = this.props
        ...
        return (
            <View pointerEvents="none" key={index + "view"} testID="inputSlotView" style={styles.vInputContainer}>
                <TextInput
                    testID="textInput"
                ...
                />
                {(isDashEnabled && index === 1) && <Text style={styles.tDash}>-</Text>}
            </View>
        )
    }
